   ...
   <div class="content-pat">
        ...
        <form method="post">  
            ...
            <div class="cont">
                ...
                <input type="text" name="link" value="<?php echo $employee_details['func_responsavel']; ?>" ><br>
            </div>
...
('categoria','titulo','autor','ano','link',''),
('Sustentabilidade e ODS ','A Política Pública de Compras Sustentáveis no Governo do Ceará','Otávio Nunes de Vasconcelos
Francisco Roberto Pinto','2016','Abrir','')
